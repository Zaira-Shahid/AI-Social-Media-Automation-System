...
4. Set the OAuth redirect URL to the Render deployment HTTPS callback, `https://<service>.onrender.com/...` (I will give you the exact path in Module 14). Final hosting decision is Render free tier — see §28. Cloudflare Tunnel and Vercel were both rejected.
